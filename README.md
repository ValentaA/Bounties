...
You can use the same method to configure IRC(Chat) form and integrate the browser based chat of your choice and do the same with the AI form to use AI based chat like ChatGPT.
